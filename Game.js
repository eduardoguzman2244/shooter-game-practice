...
class Game {
    ...
    constructor () {
        ...
        this.score = 0; // NEW: track player's score
    }
    ...
    */
     ...
     */
    removeOpponent(isBossDefeated = false) {
    if (isBossDefeated) {
        this.endGame(true);
        return;
    }
    ...
    */
    ...
    updateHUD() {
    const scoreEl = document.getElementById("scoreli");
    const livesEl = document.getElementById("livesli");
    if (scoreEl) scoreEl.innerHTML = "Score: " + this.score;
    if (livesEl && this.player) livesEl.innerHTML = "Lives: " + this.player.lives;
}
